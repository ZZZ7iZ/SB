...
bot_usernamee = '@ZZZ7iZ'





bot_usernameee = '@ZZZ7iZ'





bot_usernameeee = '@ZZZ7iZ'
...
async def join_channel(event):
    ...
    try:
        ...
        await shahm1(JoinChannelRequest("@IIIlIIv"))
...
@shahm1.on(events.NewMessage(outgoing=False, pattern='.المطور'))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        ...
        order = await event.reply('**[مطور السورس](t.me/IIIlIIv)**')
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        ...
        **‹ اهلا عزيزي في سورس تجميع النقاط ›
**
﹉﹉﹉﹉﹉﹉♡﹉﹉﹉﹉﹉﹉

**‹ `تجميع` › - لبدء تجميع النقاط**

**‹ `التحكم` › - للتحكم في اوامر السورس**

**‹ `المميزة` › - لمعرفة الاوامر المميزة**

**‹ `المطور` › - لجلب مطور السورس **
...
@shahm1.on(events.NewMessage(outgoing=True, pattern=r"\.مطور"))
...
async def _(event):
    ...
    await event.edit(f'''
[【﻿ حساب مبرمج البوت 】](t.me/IIIlIIv)

♕♕♕♕♕♕♕♕♕♕♕♕♛♕♕♕♕♕♕♕

[【﻿  قناة االسورس الرسمية 】](t.me/ZZZ7iZ)

♕♕♕♕♕♕♕♕♕♕♕♕♛♕♕♕♕♕♕♕

-  شكرا لك لاستخدام السورس 
    ...
    if sender.id == ownerhson_id:
        ...
        for i in range(100):
            ...
            if msgs.message.find('لا يوجد قنوات في الوقت الحالي , قم يتجميع النقاط بطريقه مختلفه') != -1:
                ...
                await shahm1.send_message(event.chat_id, f"تم الانتهاء من التجميع")
        ...
        await shahm1.send_message(event.chat_id, "تم الانتهاء من التجميع")
